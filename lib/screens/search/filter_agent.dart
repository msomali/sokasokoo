...
class FilterToolAgent extends StatefulWidget {
  FilterToolAgent({Key? key}) : super(key: key);

  @override
  _FilterToolState createState() => _FilterToolState();
}

class _FilterToolState extends State<FilterToolAgent> {
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        if (form.valid) {
                          var data = {...form.value, 'type': 'AGENT'};
