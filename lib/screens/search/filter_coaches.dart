...
class FilterToolCoaches extends StatefulWidget {
  FilterToolCoaches({Key? key}) : super(key: key);

  @override
  _FilterToolState createState() => _FilterToolState();
}

class _FilterToolState extends State<FilterToolCoaches> {
  ...
  FormGroup buildForm() => fb.group({
        ...
        'license_level': FormControl(value: ''),
              ...
              return Column(
                children: [
                  ...
                  ReactiveDropdownField(
                      ...
                      items: <String>['Preliminary', 'Intermediate', 'Advanced']
                          .map<DropdownMenuItem<String>>((String value) {
                        return DropdownMenuItem<String>(
                          value: value,
                          child: Text(value),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        if (form.valid) {
                          var data = {...form.value, 'type': 'COACH'};
