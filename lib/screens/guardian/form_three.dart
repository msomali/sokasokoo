...
class GuardianFormThree extends StatefulWidget {
  const GuardianFormThree({Key? key, required this.id}) : super(key: key);
  final String id;

  @override
  _GuardianFormThreeState createState() => _GuardianFormThreeState();
}

class _GuardianFormThreeState extends State<GuardianFormThree> {
  var isLoading = false;
      ...
      appBar: AppBar(elevation: 0, actions: [
        Padding(
          ...
          child: TextButton(
              onPressed: () async {
                var currentId =
                    Provider.of<UserProvider>(context, listen: false).currentId;
                var user =
