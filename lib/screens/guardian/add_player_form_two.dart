...
import 'package:sokasokoo/screens/guardian/add_player_form_three.dart';
...
class AddPlayerFormTwo extends StatefulWidget {
  AddPlayerFormTwo({Key? key, required this.id, required this.playerId})
      : super(key: key);
  String id;
  String playerId;
...
class _PlayerFormTwoState extends State<AddPlayerFormTwo> {
  ...
  void onSubmit(value) async {
    ...
    try {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => AddPlayerFromThree(
                  id: widget.id,
                )),
      );
    } on DioError catch (e) {
