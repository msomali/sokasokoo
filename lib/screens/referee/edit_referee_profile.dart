...
class EditRefereeProfile extends StatefulWidget {
  const EditRefereeProfile({Key? key, required this.user}) : super(key: key);
  final User user;

  @override
  _EditRefereeProfileState createState() => _EditRefereeProfileState();
}

class _EditRefereeProfileState extends State<EditRefereeProfile> {
  var isLoading = false;
  ...
  FormGroup buildForm() => fb.group(<String, Object>{
        ...
        'referee_license_level': FormControl<String>(
          value: widget.user.refereeLicenseLevel ?? '',
                    ...
                    children: [
                      ...
                      ReactiveTextField<String>(
                        ...
                        validationMessages: (control) => {
                          ValidationMessage.required: 'License level required',
                        },
                        textInputAction: TextInputAction.next,
                        decoration: const InputDecoration(
