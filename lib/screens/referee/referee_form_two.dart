...
import 'referee_form_three.dart';

class RefereeFormTwo extends StatefulWidget {
  RefereeFormTwo({Key? key, required this.id, required this.playerId})
      : super(key: key);
  String id;
  String playerId;

  @override
  _RefereeFormTwoState createState() => _RefereeFormTwoState();
}

class _RefereeFormTwoState extends State<RefereeFormTwo> {
  ...
  void onSubmit(value) async {
    ...
    try {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => RefereeFormThree(
                  id: widget.id,
                )),
      );
    } on DioError catch (e) {
