...
import 'package:sokasokoo/screens/academy/form_three.dart';
import 'package:sokasokoo/screens/guardian/form_three.dart';

class AcademyFormTwo extends StatefulWidget {
  AcademyFormTwo({Key? key, required this.id, required this.playerId})
      : super(key: key);
  String id;
  String playerId;

  @override
  _AcademyFormTwoState createState() => _AcademyFormTwoState();
}

class _AcademyFormTwoState extends State<AcademyFormTwo> {
  ...
  void onSubmit(value) async {
    ...
    try {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => AcademyFormThree(
                  id: widget.id,
                )),
      );
    } on DioError catch (e) {
