...
class EditAcademyProfile extends StatefulWidget {
  const EditAcademyProfile({Key? key, required this.user}) : super(key: key);
  final User user;

  @override
  _EditAcademyProfileState createState() => _EditAcademyProfileState();
}

class _EditAcademyProfileState extends State<EditAcademyProfile> {
  var isLoading = false;
  ...
  FormGroup buildForm() => fb.group(<String, Object>{
        'academy_name': FormControl<String>(
          value: widget.user.academyName ?? '',
          validators: [Validators.required],
        ),
        'academy_registration': FormControl<String>(
          value: widget.user.academyRegistration ?? '',
          validators: [Validators.required],
        ),
        'academy_description': FormControl<String>(
          value: widget.user.academyDescription ?? '',
          validators: [Validators.required],
        ),
