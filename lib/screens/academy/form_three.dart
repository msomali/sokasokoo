...
class AcademyFormThree extends StatefulWidget {
  const AcademyFormThree({Key? key, required this.id}) : super(key: key);
  final String id;

  @override
  _AcademyFormThreeState createState() => _AcademyFormThreeState();
}

class _AcademyFormThreeState extends State<AcademyFormThree> {
  var isLoading = false;
