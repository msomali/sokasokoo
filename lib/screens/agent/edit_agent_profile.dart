...
class EditAgentProfile extends StatefulWidget {
  const EditAgentProfile({Key? key, required this.user}) : super(key: key);
  final User user;
...
class _EditAgentProfileState extends State<EditAgentProfile> {
  ...
  FormGroup buildForm() => fb.group(<String, Object>{
        ...
        'company_title': FormControl<String>(
          value: widget.user.companyTitle ?? '',
          validators: [Validators.required],
        ),
        'company_description': FormControl<String>(
          value: widget.user.companyDescription ?? '',
          validators: [Validators.required],
        ),
        ...
        'firstName': [widget.user.firstName ?? '', Validators.required],
        'lastName': [widget.user.lastName ?? '', Validators.required],
        'gender': FormControl(
