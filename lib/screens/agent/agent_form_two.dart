...
import 'package:sokasokoo/screens/agent/agent_form_three.dart';

class AgentFormTwo extends StatefulWidget {
  AgentFormTwo({Key? key, required this.id, required this.playerId})
      : super(key: key);
  String id;
  String playerId;

  @override
  _AgentFormTwoState createState() => _AgentFormTwoState();
}

class _AgentFormTwoState extends State<AgentFormTwo> {
  ...
  void onSubmit(value) async {
    ...
    try {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => AgentFormThree(
                  id: widget.id,
                )),
      );
    } on DioError catch (e) {
