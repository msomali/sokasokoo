...
class PlayerFromThree extends StatefulWidget {
  const PlayerFromThree({Key? key, required this.id}) : super(key: key);
  final String id;
...
class _PlayerFromThreeState extends State<PlayerFromThree> {
  var isLoading = false;
