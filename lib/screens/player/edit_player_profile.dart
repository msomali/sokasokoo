...
class EditPlayerProfile extends StatefulWidget {
  const EditPlayerProfile({Key? key, required this.user}) : super(key: key);
  final User user;

  @override
  _EditPlayerProfileState createState() => _EditPlayerProfileState();
}
...
class _EditPlayerProfileState extends State<EditPlayerProfile> {
  ...
  FormGroup buildForm() => fb.group(<String, Object>{
        ...
        'education_level': [
          widget.user.educationLevel ?? '',
          Validators.required
        ],
        'national_team_call': [widget.user.national_team_call ?? 0],
        'national_youth_call': [widget.user.national_team_call ?? 0],
        'short_bio': [widget.user.short_bio ?? ''],
        'umiseta_games': [widget.user.umiseta_games ?? ''],
        'umitashumta_games': [widget.user.umitashumta_games ?? ''],
                  ...
                  return Column(
                    children: [
                      ...
                      ReactiveDropdownField(
                          ...
                          items: <String>['National', 'Regional', 'District']
                              .map<DropdownMenuItem<String>>((String value) {
                            return DropdownMenuItem<String>(
                              value: value,
                              child: Text(value),
