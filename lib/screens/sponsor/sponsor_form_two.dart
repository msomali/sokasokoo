...
import 'package:sokasokoo/screens/sponsor/sponsor_contact_form.dart';

class IndividualSponsorFormTwo extends StatefulWidget {
  IndividualSponsorFormTwo({Key? key, required this.id, required this.playerId})
      : super(key: key);
  String id;
  String playerId;

  @override
  _IndividualSponsorFormTwoState createState() =>
      _IndividualSponsorFormTwoState();
}

class _IndividualSponsorFormTwoState extends State<IndividualSponsorFormTwo> {
  ...
  void onSubmit(value) async {
    ...
    try {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => SponsorFormThree(
                  id: widget.id,
                )),
      );
    } on DioError catch (e) {
