...
class EditEntitySponsorProfile extends StatefulWidget {
  const EditEntitySponsorProfile({Key? key, required this.user})
      : super(key: key);
  final User user;

  @override
  _EditEntitySponsorProfileState createState() =>
      _EditEntitySponsorProfileState();
}

class _EditEntitySponsorProfileState extends State<EditEntitySponsorProfile> {
  var isLoading = false;
  ...
  FormGroup buildForm() => fb.group(<String, Object>{
        'entity_name': FormControl(
            value: widget.user.entityName ?? '',
