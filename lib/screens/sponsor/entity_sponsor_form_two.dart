...
class EntitySponsorFormTwo extends StatefulWidget {
  EntitySponsorFormTwo({Key? key, required this.id, required this.playerId})
      : super(key: key);
  String id;
  String playerId;

  @override
  _EntitySponsorFormTwoState createState() => _EntitySponsorFormTwoState();
}

class _EntitySponsorFormTwoState extends State<EntitySponsorFormTwo> {
