...
class CoachFormOne extends StatefulWidget {
  const CoachFormOne({Key? key, required this.type}) : super(key: key);
  final String type;

  @override
  _CoachFormOneState createState() => _CoachFormOneState();
}
...
class _CoachFormOneState extends State<CoachFormOne> {
                        ...
                        onPressed: () async {
                          if (form.valid) {
                            ...
                            try {
                              ...
                              if (e.response!.data['errors']['phone']['type'] ==
                                  'unique') {
