...
import 'package:sokasokoo/screens/vendor/vendors_form_two.dart';

class VendorFormOne extends StatefulWidget {
  const VendorFormOne({Key? key, required this.type}) : super(key: key);
  final String type;

  @override
  _VendorFormOneState createState() => _VendorFormOneState();
}
...
class _VendorFormOneState extends State<VendorFormOne> {
  ...
  FormGroup buildForm() => fb.group(<String, Object>{
        ...
        'vendor_type': FormControl<String>(
          validators: [Validators.required],
        ),
              ...
              return Column(
                children: [
                  ...
                  ReactiveDropdownField(
                      ...
                      items: <String>['GOODS', 'SERVICES', 'GOODS & SERVICES']
