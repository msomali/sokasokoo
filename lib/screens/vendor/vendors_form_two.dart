...
import 'package:sokasokoo/screens/vendor/vendors_form_three.dart';

class VendorFormTwo extends StatefulWidget {
  VendorFormTwo({Key? key, required this.id, required this.playerId})
      : super(key: key);
  String id;
  String playerId;

  @override
  _VendorFormTwoState createState() => _VendorFormTwoState();
}

class _VendorFormTwoState extends State<VendorFormTwo> {
  ...
  void onSubmit(value) async {
    ...
    try {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => VendorFormThree(
                  id: widget.id,
                )),
      );
    } on DioError catch (e) {
